...
### beforeAction() · [source](../../src/Core/Controller.php#L45)

`public function beforeAction(string|null $action = null, array $params = []): Azera\Http\Response|null`
...
### afterAction() · [source](../../src/Core/Controller.php#L56)

`public function afterAction(string|null $action = null, array $params = []): Azera\Http\Response|null`
...
### getMiddleware() · [source](../../src/Core/Controller.php#L67)
...
### getActionMiddleware() · [source](../../src/Core/Controller.php#L77)
...
### context() · [source](../../src/Core/Controller.php#L88)
...
### request() · [source](../../src/Core/Controller.php#L97)
...
### view() · [source](../../src/Core/Controller.php#L106)
...
### session() · [source](../../src/Core/Controller.php#L115)
...
### cookies() · [source](../../src/Core/Controller.php#L124)
