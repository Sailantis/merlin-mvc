 ...
 * @property-read string[] $sourceFiles        Unique source file paths, indexed by the integers in $sourceMap.
...
class CompiledTemplate
{
     ...
     * @param string[] $sourceFiles        Unique source file paths (parallel to $sourceMap file indices).
     */
